...
function useFieldsetRootContext(optional = false) {
	...
	if (!context && !optional) throw new Error(formatErrorMessage(86));
	return context;
}
//#endregion
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox-group/CheckboxGroupContext.js
var CheckboxGroupContext = /* @__PURE__ */ import_react.createContext(void 0);
function useCheckboxGroupContext(optional = true) {
	const context = import_react.useContext(CheckboxGroupContext);
	if (context === void 0 && !optional) throw new Error(formatErrorMessage(3));
	return context;
}
//#endregion
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox/root/CheckboxRootDataAttributes.js
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox/utils/useStateAttributesMapping.js
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox/root/CheckboxRootContext.js
...
function useCheckboxRootContext() {
	...
	if (context === void 0) throw new Error(formatErrorMessage(14));
	return context;
}
//#endregion
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox/root/CheckboxRoot.js
...
var CheckboxRoot = /* @__PURE__ */ import_react.forwardRef(function CheckboxRoot(componentProps, forwardedRef) {
	const { checked: checkedProp, className, defaultChecked = false, "aria-labelledby": ariaLabelledByProp, disabled: disabledProp = false, form, id: idProp, indeterminate = false, inputRef: inputRefProp, name: nameProp, onCheckedChange: onCheckedChangeProp, parent = false, readOnly = false, render, required = false, uncheckedValue, value: valueProp, nativeButton = false, style, ...elementProps } = componentProps;
	...
	const inputProps = mergeProps$1({
		...
		onChange(event) {
			...
			if (value && groupValue && setGroupValue && !parent && !isGroupedWithParent) setGroupValue(nextChecked ? [...groupValue, value] : groupValue.filter((item) => item !== value), details);
		},
		onFocus() {
			controlRef.current?.focus();
		}
	}, valueProp !== void 0 ? { value: (groupContext ? checked && valueProp : valueProp) || "" } : EMPTY_OBJECT, getDescriptionProps, groupContext ? validation.getValidationProps : validation.getInputValidationProps);
...
//#endregion
//#region node_modules/@base-ui/react/esm/checkbox/indicator/CheckboxIndicator.js
/**
...
var CheckboxIndicator = /* @__PURE__ */ import_react.forwardRef(function CheckboxIndicator(componentProps, forwardedRef) {
	...
	const stateAttributesMapping = import_react.useMemo(() => ({
...
//#endregion
//#region node_modules/@base-ui/react/esm/radio-group/RadioGroupContext.js
...
function useRadioRootContext() {
	...
	if (value === void 0) throw new Error(formatErrorMessage(52));
	return value;
}
//#endregion
...
var SelectTrigger = /* @__PURE__ */ import_react.forwardRef(function SelectTrigger(componentProps, forwardedRef) {
	...
	const hasNullItemLabel = useStore(store, selectors$1.hasNullItemLabel, shouldCheckNullItemLabel);
...
var stateAttributesMapping$4 = { value: () => null };
/**
...
//#endregion
export { Input as A, SelectTrigger as C, RadioRoot as D, RadioIndicator as E, require_with_selector as F, require_jsx_runtime as I, require_react as L, Button as M, mergeProps$1 as N, CheckboxIndicator as O, require_react_dom as P, SelectValue as S, RadioGroup as T, SelectList as _, DialogDescription as a, SelectPortal as b, AlertDialogRoot as c, SwitchRoot as d, SelectScrollUpArrow as f, SelectItem as g, SelectItemIndicator as h, DialogPopup as i, Separator as j, CheckboxRoot as k, DialogRoot as l, SelectItemText as m, DialogTitle as n, DialogClose as o, SelectScrollDownArrow as p, DialogPortal as r, DialogBackdrop as s, useRender as t, SwitchThumb as u, SelectPopup as v, SelectRoot as w, SelectIcon as x, SelectPositioner as y };
