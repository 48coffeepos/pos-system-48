  ...
  return (
    <main className="page-wrap flex min-h-[60vh] items-center justify-center px-4 py-12">
      <div className="island-shell max-w-md rounded-2xl p-6 text-center shadow-sm sm:p-8">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-5 py-2.5 text-sm font-semibold text-[var(--lagoon-deep)] no-underline transition hover:-translate-y-0.5 hover:bg-[rgba(79,184,178,0.24)]"
        >
          Go home
        </Link>
      </div>
    ...
    <main className="page-wrap flex min-h-[60vh] items-center justify-center px-4 py-12">
      <div className="island-shell max-w-xl rounded-2xl p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-[var(--sea-ink)] no-underline transition hover:bg-[rgba(79,184,178,0.12)]"
          >
            Go home
          </Link>
        </div>
