...
export type InventoryLogWhereInput = {
  ...
  inventory_log_id?: Prisma.StringFilter<"InventoryLog"> | string
  date_time?: Prisma.DateTimeNullableFilter<"InventoryLog"> | Date | string | null
...
export type InventoryLogOrderByWithRelationInput = {
  inventory_log_id?: Prisma.SortOrder
...
export type InventoryLogScalarWhereWithAggregatesInput = {
  ...
  inventory_log_id?: Prisma.StringWithAggregatesFilter<"InventoryLog"> | string
  date_time?: Prisma.DateTimeNullableWithAggregatesFilter<"InventoryLog"> | Date | string | null
...
export type InventoryLogUpdateInput = {
  inventory_log_id?: Prisma.StringFieldUpdateOperationsInput | string
...
export type EnumLog_typeFieldUpdateOperationsInput = {
  set?: $Enums.Log_type
}
...
export type InventoryLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"inventory_log_id" | "date_time" | "expense" | "quantity" | "inventory_item" | "location" | "log_by" | "type", ExtArgs["result"]["inventoryLog"]>
...
export interface InventoryLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `inventory_log_id`
   * const inventoryLogWithInventory_log_idOnly = await prisma.inventoryLog.findMany({ select: { inventory_log_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many InventoryLogs and only return the `inventory_log_id`
   * const inventoryLogWithInventory_log_idOnly = await prisma.inventoryLog.createManyAndReturn({
   *   select: { inventory_log_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more InventoryLogs and only return the `inventory_log_id`
   * const inventoryLogWithInventory_log_idOnly = await prisma.inventoryLog.updateManyAndReturn({
   *   select: { inventory_log_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface InventoryLogFieldRefs {
  readonly inventory_log_id: Prisma.FieldRef<"InventoryLog", 'String'>
  readonly date_time: Prisma.FieldRef<"InventoryLog", 'DateTime'>
