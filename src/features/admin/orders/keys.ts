const orderKeys = {
  ...
  paginated: (params: { page: number; timeframe?: string; fromDate?: string; toDate?: string }) =>
    [...orderKeys.all, "paginated", String(params.page), params.timeframe ?? "", params.fromDate ?? "", params.toDate ?? ""] as const,
};
