...
export function PosReceiptDialog({
	...
	return (
		...
		>
			<AlertDialogContent className="w-[calc(100vw-2rem)] max-w-[380px] border-(--light-gray) bg-(--pure-white) p-0">
				<div className="flex flex-col max-h-[85vh] p-4 sm:p-6">
					<Button
						variant="ghost"
						size="icon"
						onClick={onClose}
					...
					<div className="no-print flex flex-col gap-3 pt-3 bg-(--pure-white)">
						...
						{bixolonReady ? (
							...
							<Button
								disabled
								className={cn(
									"flex h-10 w-full gap-2 text-xs opacity-50",
									posBtnOutline,
								)}
							>
								Detecting printer...
