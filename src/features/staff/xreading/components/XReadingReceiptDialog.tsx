          ...
          <div id="sales-xreading-receipt">
            <div className="mb-4 text-center">
              ...
              <h3 className="text-lg font-bold uppercase tracking-widest">
                {dateMode === "me" ? "SALES X-READING" : "SALES Z-READING"}
              </h3>
            </div>
            ...
            <div className="mb-4 text-sm font-bold">
              ...
              <div className="flex justify-between">
                <span>{dateMode === "me" ? "Cashier :" : "Generated By :"}</span>
                <span>{staffName}</span>
              </div>
            </div>
        ...
        {mode === "cashcount" && (
          <div id="cash-count-receipt">
            <div className="mb-4 text-center">
              ...
              <p className="text-sm font-bold">{dateMode === "me" ? "Cashier" : "Generated By"}: {staffName}</p>
            </div>
